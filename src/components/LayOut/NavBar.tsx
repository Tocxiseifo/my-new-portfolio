...
export default function NavBar() {
    ...
    return (
        <>
            <motion.nav  initial={{opacity:0 , y:100}} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{duration:1 , ease:'easeOut' ,delay:0.2}} className="w-full flex-col h-18 justify-center text-center   items-center hidden lg:flex gap-5   bg-white z-50 font-seif  fixed top-0">
