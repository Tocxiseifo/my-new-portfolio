        ...
        <section id="Contact" className="flex flex-col w-full h-auto px-4  sm:px-6 lg:px-0">
            ...
            <div className="flex flex-col lg:flex-row gap-8 lg:gap-2 items-start lg:items-center justify-between py-10 sm:py-14 lg:py-20">
                <div className="flex flex-col gap-2">
                    ...
                    <motion.h2 initial={{opacity:0 , x:-100}} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{duration:1 , ease:'easeOut' ,delay:1}} className="text-2xl sm:text-3xl lg:text-4xl text-gray-600 font-bold tracking-tighter lg:ml-5 lg:w-120">Front-End Developer</motion.h2>
                </div>
